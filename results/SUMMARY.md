...
> Source: `papers/manuscript_summaries.json` · 122 papers · span 1990–2026.

## Headline

- **122 manuscripts** summarized with Gemma 4 12B and validated against the Pydantic `ManuscriptChecklist` schema.
- **22 / 122 (18%)** identified as using EHR / claims / linked administrative health data.
